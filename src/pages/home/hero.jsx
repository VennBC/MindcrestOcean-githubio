...
export default function () {
  ...
  return (
      <div className="section bg-light pb-9 pt-5 overflow-hidden">
      ...
      <div className="overlay opacity-90 z-index-n1">
        <svg style={{width: '100%', height: '100%', transform: 'scale(1.4, 1)'}} xmlns="http://www.w3.org/2000/svg" width="1920" height="1000" preserveAspectRatio="xMidYMid" viewBox="0 0 1920 1000">
          <g transform="translate(960,437.5) scale(1,1) translate(-960,-437.5)"><linearGradient id="lg-0.7760586418593289" x1="0" x2="1" y1="0" y2="0">
            <stop stop-color="#6a26da" offset="0"></stop>
            <stop stop-color="#6a26da" offset="1"></stop>
      ...
      <div className="container-fluid px-7 pb-2">
        <div className="row justify-content-center">
          <div className="col-md-5 col-8 align-self-center pe-5" data-aos="fade-right">
            <div className="text-start mt-6 mt-2">
              ...
              <a className="btn datasophon-btn btn-green mt-20 ml-3 ztop" href="docs/current/概览"
